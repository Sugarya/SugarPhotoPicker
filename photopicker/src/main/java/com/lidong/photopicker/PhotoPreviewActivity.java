...
public class PhotoPreviewActivity extends AppCompatActivity implements PhotoPagerAdapter.PhotoViewClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isShowDeleteBtn = getIntent().getBooleanExtra(EXTRA_CAN_DELETE,true);
    ...
    private void initViews(){
        ...
        getSupportActionBar().setHomeAsUpIndicator(getResources().getDrawable(R.drawable.icon_header_left));
    }
